...
Axis rightAxis(ENB, IN3, IN4, ENCODER2B, ENCODER2A, "Right-axis", RIGHT_EEPROM_ADR, DISTPERROT, ENCODERSTEPS);
Axis zAxis    (ENA, IN1, IN2, ENCODER1A, ENCODER1B, "Z-Axis",         Z_EEPROM_ADR, ZDISTPERROT, ZENCODERSTEPS);
